...
int main(int argc, char *argv[])
{
    ...
    const auto mq_password = chatnow::config::resolve_secret(
        chatnow::config::SecretId::TransmiteMqPassword);
    ...
    tsb.make_mq_object(FLAGS_mq_user, mq_password, FLAGS_mq_host, FLAGS_mq_msg_exchange, FLAGS_mq_msg_queue, FLAGS_mq_msg_binding_key);
