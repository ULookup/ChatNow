    ...
    : QWidget{parent}
{
    ...
    // 9. 创建切换到手机号登录按钮
    mailModeBtn = new QPushButton();
    mailModeBtn->setFixedSize(100, 40);
    mailModeBtn->setText("邮箱登录");
    ...
    mailModeBtn->setStyleSheet(btnWhiteStyle);
