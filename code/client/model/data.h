...
public:
    ...
    void load(const chatnow::UserInfo& userInfo) {
...
public:
    ...
    void load(const chatnow::MessageInfo& messageInfo) {
        ...
        if (type == chatnow::MessageTypeGadget::MessageType::STRING) {
            this->messageType = TEXT_TYPE;
            this->content = messageInfo.message().stringMessage().content().toUtf8();
        } else if (type == chatnow::MessageTypeGadget::MessageType::IMAGE) {
        ...
        } else if (type == chatnow::MessageTypeGadget::MessageType::FILE) {
        ...
        } else if (type == chatnow::MessageTypeGadget::MessageType::SPEECH) {
...
public:
    ...
    void load(const chatnow::ChatSessionInfo& chatSessionInfo) {
