...
public:
    ...
    void clickMailSubmitBtn();
    void clickMailSubmitBtnDone();
    void clickAvatarBtn();
...
private:
    ...
    QLabel* mailTag;							// 显示 "电话"
    QLabel* mailLabel;							// 显示 "18612345678"
    QLineEdit* mailEdit;						// 编辑电话
    QPushButton* mailModifyBtn;				// 修改电话
    QPushButton* mailSubmitBtn;				// 提交修改
