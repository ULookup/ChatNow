...
public:
    ...
    // 针对 websocket 的处理
    void handleWsResponse(const chatnow::NotifyMessage& notifyMessage);
    ...
    void changeMail(const QString& loginSessionId, const QString& mail, const QString& verifyCodeId, const QString& verifyCode);
    ...
    void mailLogin(const QString& mail, const QString& verifyCodeId, const QString& verifyCode);
    void mailRegister(const QString& mail, const QString& verifyCodeId, const QString& verifyCode);
