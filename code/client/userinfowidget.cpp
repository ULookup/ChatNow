...
UserInfoWidget::UserInfoWidget(const UserInfo& userInfo, QWidget* parent)
    ...
    mailTag->setFixedSize(width, height);
    mailTag->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);

    mailLabel = new QLabel();
    mailLabel->setText(userInfo.mail);
    mailLabel->setFixedSize(width, height);
    mailLabel->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    ...
    layout->addWidget(mailTag, 2, 1);
    layout->addWidget(mailLabel, 2, 2);
